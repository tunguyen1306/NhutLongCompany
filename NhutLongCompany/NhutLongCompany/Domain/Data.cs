...
namespace NhutLongCompany.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 5, nameOption = "Báo Giá", controller = "Sanxuat", action = "Index", imageClass = "fa fa-file-o fa-2x", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id =6, nameOption = "Báo Giá", controller = "Sanxuat", action = "Index", imageClass = "fa fa-file-o fa-", status = true, isParent = false, parentId = 5 });
